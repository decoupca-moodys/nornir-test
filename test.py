...
os.environ["NET_TEXTFSM"] = '/usr/local/lib/python3.9/site-packages/ntc_templates/templates'

nr = InitNornir(config_file="config.yaml")
host = nr.filter(name='SWTC21AC02')

result = host.run(task=netmiko_send_command, command_string="show cdp neighbors detail", use_textfsm=True)
print_result(result)
